...
import { signUp, signIn, signOut, fetchingCurrentUser } from "./authController-operations";
...
const authController = createSlice({
    ...
    extraReducers: (builder) =>{
        ...
        .addCase(fetchingCurrentUser.pending,
            (state)=>{
                state.isLoading = true;
                state.error = null;
                state.isFetchingCurrentUser = true;
            })
        .addCase(fetchingCurrentUser.fulfilled,
             (state, { payload })=>{
                state.user = payload;
                state.isLoggedIn = true;
                state.isLoading = false;
        ...
        .addCase(fetchingCurrentUser.rejected,
            (state, { payload })=>{
                state.isLoggedIn = false;
                state.isLoading = false;
                state.error= payload;
